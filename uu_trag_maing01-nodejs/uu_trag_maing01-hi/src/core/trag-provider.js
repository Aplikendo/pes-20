...
const TragContext = UU5.Common.Context.create();
const TragConsumer = TragContext.Consumer;


const TragProvider = UU5.Common.Component.create({
  ...
  render() {
    return (
      <TragContext.Provider value={this.state.data}>
        {this.props.children}
      </TragContext.Provider>
    );
  }
  //@@viewOff:render
});

export {TragConsumer, TragProvider};
export default TragProvider;
